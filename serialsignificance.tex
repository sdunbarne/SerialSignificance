...
\begin{enumerate}
    ...
    \item
        ...
        \ell \)-smallest} in \( \alpha_0, \dots \alpha_n \) if there
...
\begin{proof}
    \begin{enumerate}
    \item For simplicity, omit the value function in the proof and
      just say \( \rho(j; \ell, n) = \Prob{X_j \text{ is among-\( \ell \)-smallest
                in } X_0, \dots, X_n } \).
      For a first understanding of the
      ...
      the focus.
        ...
        \item
            ...
            \begin{multline*}
                ...
                \Prob{X_{s+j} \text{ is among-\( \ell \)-smallest in
...
\end{exercise}
\begin{solution}
    This is Corollary 10.4, page 63 of \booktitle{Heads or Tails:  An
    ...
    Feller's \booktitle{An Introduction to Probability Theory and Its
