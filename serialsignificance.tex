...
\begin{proof}
    \begin{enumerate}
        ...
        \item
            ...
            \end{multline*}
        \item
            \label{enum:serialsignificance:basethm5} Because \( X = X_0 , X_1,
        ...
        \item
            \label{enum:serialsignificance:basethm7} Using the previous steps
            \begin{align*}
                \rho(j; 2\ell, n \given \sigma) &\ge \rho(j; \ell, j
                \given \sigma) \cdot \rho(0; \ell, n-j \given \sigma) \\
            ...
            \ref{enum:serialsignificance:basethm6}.  The middle equality comes
            from step~%
            \ref{enum:serialsignificance:basethm5}. The last inequality comes
